...
1. Vue 3 - Sometimes a light single page application is a fine thing to want to build
2. Pinia - for auth credentials and other things an app would want saved app-wide
3. Spring - Backend, vue's going to call all the things here
